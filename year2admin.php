...
<body>
	<div class="container">
     ...
     <br><br>
            ...
            <br>
	<form action="year2admin.inc.php" method="POST">
	...
	<div  class="form-actions" style="font-family:Lato,sans-serif; line-height: 1.0; font-size: 12px; text-align: left; color: #757575;">
		<i style=" font-style: italic;">Any alterations in the courses you registered with will be informed through email.</i>
<br><br>
