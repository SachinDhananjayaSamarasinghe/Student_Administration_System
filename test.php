...
<body>
    <div class="container">
            <div class="row">
             <legend><h3>Online Course Registration </h3></legend>   
            </div>

            <br>

     <div style="font-family:Lato,sans-serif; font-style: italic; line-height: 1.5; font-size: 15px; text-align: center; color: #757575; ">
          <i>Please select relevant year of your general/special degree for course registration.</i>
          <br><br>
          <i>3 <sup>rd</sup>year special degree students must register for both 3 <sup>rd</sup>year general and special degree courses.</i>      
            ...
            <div class="row">
             ...
             <div  style="color:#5c5c3d ; margin-left: 25px;">
                ...
                <p style="float: left; margin-top: 20px; margin-left: 75px;">
                    <a href="year1.php" class="btn btn-success"> &nbsp &nbsp 1 <sup>st</sup> Year  &nbsp &nbsp</a>
                </p>          
               
<br><br><br><br><br><br>
                 <p style="margin-top: -30px;  margin-left: 75px;">
                    <a href="year2.php" class="btn btn-danger"> &nbsp &nbsp 2<sup>nd</sup> Year  &nbsp &nbsp</a>
                </p>
               <br>

                <br><br>
                 <p style="margin-top: -30px;  margin-left: 75px;">
                    <a href="year3.php" class="btn btn-info"> &nbsp &nbsp 3 <sup>rd</sup> Year  &nbsp &nbsp</a>
                </p>
               <br>
...
<br><br>
 ...
 <br>
    ...
    <?php if (isset($_SESSION["name"])):?>
        <br><br><br><br>
    <p style="margin-left: 21px; font-size: 17px; font-family: 'calbri'">Welcome <strong><?php echo $_SESSION['name']; ?></strong></p>
    <br>
    <p><a href="test.php?logout='1'" style="color:#5c5c3d;  font-weight: bold; font-size: 20px; margin-left: 95px; text-decoration: none;">
      Logout</a></p>
     <?php endif ?>
