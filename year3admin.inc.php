...
if ($valid) {
	$sql= "INSERT INTO year3(sub1,sub2, sub3, sub4, sub5, sub6, sub7, sub8, sub9, sub10, sub11, sub12, sub13, sub14, sub15, sub16, email)
		VALUES('$mi','$mii','$bio','$cs','$es','$chem', '$phy', '$poe', '$lat', '$pom', '$rm', '$cd', '$pa', '$be', '$pcm', '$hrm', '$email');";
